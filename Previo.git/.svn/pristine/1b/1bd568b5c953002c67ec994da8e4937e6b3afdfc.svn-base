 ...
 * de la Galería de Videos de Ítem
 * 
 * @author Adquem
 * @version 1.0
 */
public class Act_GalleryItemVideo extends Activity {
	...
	/**
	 * Clase para mostrar los Videos contenidos en la Galería de Videos de Ítem
	 * y la Eliminación de Videos
	 */
	public class MyThumbnaildapter extends ArrayAdapter<String> {
		...
		/**
		 * Crea la Vista para Mostrar los Videos de Ítem
		 * 
		 * @param position
		...
		public View getView(final int position, View convertView,
			...
			row.setOnClickListener(new OnClickListener() {
				 ...
				 * Ítem pasando el path de los Videos a mostrar
				 */
				@Override
				public void onClick(View v) {
					// TODO Auto-generated method stub
					Intent playVideo = new Intent(Act_GalleryItemVideo.this,
			...
			chebox.setOnClickListener(new OnClickListener() {
				/**
				 * Realiza la Eliminación de los Videos de Ítem pasando el path
	...
	/**
	 * Crea la Vista de Galería para mostrar la Lista de Videos de Ítem
	 */
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		tituloGaleria
				.setText(getString(R.string.str_galerias_txtv_tituloGaleriaVideoItem));
		...
		basura.setOnClickListener(new OnClickListener() {
			/**
			 * Realiza la Eliminación de los Videos de Ítem eliminándolos de la
			...
			public void onClick(View v) {
				...
				if (sincronizado != Constantes.ESTATUS_SINCRONIZADO) {
					...
					Toast.makeText(
							getBaseContext(),
							getString(R.string.str_galeriaItem_toast_eliminarVideoItemSinc),
	...
	public class cargaGaleriaVideos extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			progress = new ProgressDialog(Act_GalleryItemVideo.this);
			progress.setTitle(getString(R.string.str_galerias_asyncTask_galeriaVideosTitulo));
		...
		/**
		 * Genera Listado de Videos Ítem agregándolos a un Archivo para ser mostrados
		...
		protected Void doInBackground(Void... params) {
			...
			if (Padre != 0) {
				...
				Toast.makeText(getApplicationContext(),
						getString(R.string.str_galerias_toast_sinVideosItem),
						Toast.LENGTH_LONG).show();
				Log.i(getString(R.string.str_galerias_log_sinDirectorioVideoMsg),
						getString(R.string.str_galerias_log_sinDirectorioVideoTag));
			}
			return null;
		}

		/**
		 * Muestra la Vista de Galería de Videos de Ítem después de mostrar el
		 * Dialogo de Progreso
		 */
		@Override
