...
//            authtoken = createdUser.sessionToken;
        ...
        Log.i("Este es en token", authtoken);
    ...
    public String userSignIn(String user, String pass, String authType) throws Exception {
        String url = "http://ldodarwin2.glsistemas.com/ScaAndroidService/api/Auth?user="+user+"&pwd="+md5(pass);
	...
	static String md5(String pass) throws Exception {
