...
import static com.adquem.grupologistics.utilities.AccountGeneral.*;


public class Util_Authenticator extends AbstractAccountAuthenticator {

    private String TAG = "AdquemAuthenticator";
    private final Context mContext;

    public Util_Authenticator(Context context) {
        super(context);
    ...
    public Bundle getAuthToken(AccountAuthenticatorResponse response, Account account, String authTokenType, Bundle options) throws NetworkErrorException {
        ...
        Log.d("Adquem", TAG + "> peekAuthToken returned - " + authToken);
        ...
        if (TextUtils.isEmpty(authToken)) {
            ...
            if (password != null) {
                try {
                    Log.d("Adquem", TAG + "> re-authenticating with the existing password");
